...
public class Cotizaciondetalle implements Serializable {
    ...
    @JoinColumn(name = "idcotizacion", referencedColumnName = "idcotizaciones")
    ...
    public String toString() {
        return "com.cristiantoma.entities.Cotizaciondetalle[ idcotizaciondetalle=" + idcotizaciondetalle + " ]";
    }
